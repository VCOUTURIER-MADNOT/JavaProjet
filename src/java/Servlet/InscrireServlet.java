...
public class InscrireServlet extends HttpServlet {
    ...
    private String URLOk = "/WEB-INF/inscrire.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(session == null || session.getAttribute("login") == null)
        {
            ...
            String rep = ge.inscrire(login, mdp, nom);
        ...
        {
            request.setAttribute("msg", "Vous êtes actuellement connecté, impossible de créer un nouvel utilisateur.");
